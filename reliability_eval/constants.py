...
MODEL_METADATA = {
    ...
    # BEGIN generated by `rp gen tables` from rp/registry/models.yaml: MODEL_METADATA
...
MODEL_CATEGORY = {
    ...
    # BEGIN generated by `rp gen tables` from rp/registry/models.yaml: MODEL_CATEGORY
