...
MODEL_METADATA = {
    ...
    # BEGIN MODEL_METADATA rows generated by `rp gen tables --write` from the model registry rp/registry/models.yaml of the reliability_posttraining repo; edit that, not these rows
    # google/gemma-4-26B-A4B-it
    "taubench_toolcalling_gemma4_26b_a4b": {
        "date": "2026-04-02",
        "provider": "Google",
    },
    # zai-org/GLM-4.7-Flash
    "taubench_toolcalling_glm47_flash": {
        "date": "2026-01-19",
        "provider": "Zhipu",
    },
    # openai/gpt-oss-120b
    "taubench_toolcalling_gpt_oss_120b": {
        "date": "2025-08-05",
        "provider": "OpenAI",
    },
    # openai/gpt-oss-20b
    "taubench_toolcalling_gpt_oss_20b": {
        "date": "2025-08-05",
        "provider": "OpenAI",
    },
    # RedHatAI/Llama-3.3-70B-Instruct-FP8-dynamic
    "taubench_toolcalling_llama33_70b_fp8": {
        "date": "2024-12-06",
        "provider": "Meta",
    },
    # allenai/Olmo-3.1-32B-Instruct
    "taubench_toolcalling_olmo31_32b": {
        "date": "2025-12-15",
        "provider": "Ai2",
    },
    # Qwen/Qwen3-30B-A3B-Instruct-2507
    "taubench_toolcalling_qwen3_30b_a3b": {
        "date": "2025-07-29",
        "provider": "Alibaba",
    },
    # Qwen/Qwen3-4B-Instruct-2507
    "taubench_toolcalling_qwen3_4b": {
        "date": "2025-08-06",
        "provider": "Alibaba",
    },
    # Qwen/Qwen3-8B
    "taubench_toolcalling_qwen3_8b": {
        "date": "2025-04-29",
        "provider": "Alibaba",
    },
    # Qwen/Qwen3.5-35B-A3B
    "taubench_toolcalling_qwen3_5_35b_a3b": {
        "date": "2026-02-24",
        "provider": "Alibaba",
    },
    # Qwen/Qwen3.5-9B
    "taubench_toolcalling_qwen3_5_9b": {
        "date": "2026-03-02",
        "provider": "Alibaba",
    },
...
MODEL_CATEGORY = {
    ...
    # BEGIN MODEL_CATEGORY rows generated by `rp gen tables --write` from the model registry rp/registry/models.yaml of the reliability_posttraining repo; edit that, not these rows
